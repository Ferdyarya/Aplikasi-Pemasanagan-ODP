                        ...
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('pemasangan.update', $item->id) }}"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select" name="id_masterclient" id="client"
                                                    style="border-radius: 8px;" data-placeholder="Pilih Client">
                                                    <option></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="time" name="waktumulai"
                                                    ...
                                                    id="waktumulai"
                                                    value="{{ old('waktumulai', $pemasangan->waktumulai) }}" required>
                                                @error('waktumulai')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="time" name="waktuselesai"
                                                    ...
                                                    id="waktuselesai"
                                                    value="{{ old('waktuselesai', $pemasangan->waktuselesai) }}"
                                                    required>
                                                @error('waktuselesai')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $item->kapasitas }}" type="text" name="kapasitas"
                                                    class="form-control" placeholder="Masukkan Kapasitas" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="odcterhubung">ODC Terhubung</label>
                                                <input value="{{ $item->odcterhubung }}" type="text" name="odcterhubung"
                                                    class="form-control" placeholder="Masukkan ODC Terhubung" required>
                                            </div>
