        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <div class="row g-3 align-items-center mb-4">
                    ...
                    {{-- Button Export PDF --}}
                    <div class="col-auto">
                        <a href="{{ route('lapangan.create')}}" class="btn btn-warning">
                            Tambah Data
                        </a>
                    </div>
                </div>
                <div>
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th class="px-6 py-2">{{ $index + $lapangan->firstItem() }}</th>
                                ...
                                <td class="px-6 py-2">
                                    <a href="{{ route('lapangan.edit', $item->id) }}" class="btn btn-primary">Edit</a>
                                    <form action="{{ route('lapangan.destroy', $item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('delete')
