                        ...
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('izinlokasi.update', $item->id) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $item->tglkunjungan }}" type="date" name="tglkunjungan"
                                                    class="form-control" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="tujuan">Tujuan</label>
                                                <input value="{{ $item->tujuan }}" type="text" name="tujuan"
                                                    class="form-control" placeholder="Masukkan Tujuan" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="alasan">Alasan</label>
                                                <input value="{{ $item->alasan }}" type="text" name="alasan"
                                                    class="form-control" placeholder="Masukkan Alasan" required>
                                            </div>
