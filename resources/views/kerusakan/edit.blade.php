                  ...
                  <div class="row justify-content-center">
                      <div class="col-8">
                          <div class="card" style="border-radius: 10px;">
                              <div class="card-body">
                                <form method="POST" action="{{ route('kerusakan.update', $item->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')

                                    <div class="form-group mb-3">
                                        <label for="id_masterclient">Client</label>
                                        <select class="form-select" name="id_masterclient" id="client" style="border-radius: 8px;" data-placeholder="Pilih Client">
                                            <option></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea value="{{ $item->ketkerusakan }}" type="text" name="ketkerusakan" class="form-control" placeholder="Masukkan Keterangan Kerusakan" required>
                                    </div>
