...
@section('content')
    ...
    <title>Master Data Teknisi</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Teknisi</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('masterteknisi.store') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama"
                                                    ...
                                                    id="nama" aria-describedby="emailHelp" placeholder="Masukan Nama"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="notelp"
                                                    ...
                                                    id="notelp" aria-describedby="emailHelp"
                                                    placeholder="Masukan Nomor Telpon" value="{{ old('notelp') }}" required>
                                                @error('notelp')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
