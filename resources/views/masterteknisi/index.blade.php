          ...
          <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <div class="row g-3 align-items-center mb-4">
                      <div class="col-auto">
                          <form action="masterteknisi" method="GET">
                      ...
                      {{-- Button Export PDF --}}
                      <div class="col-auto">
                          <a href="{{ route('masterteknisi.create')}}" class="btn btn-warning">
                              Tambah Data
                          </a>
                          {{-- <a href="{{ route('masterteknisipdf')}}" class="btn btn-danger">
                              Export PDF
                          </a> --}}
                      </div>
                  </div>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <form action="{{ route('masterteknisi.destroy', $item->id) }}" method="POST" style="display:inline;">
                                          @csrf
                                          @method('delete')
