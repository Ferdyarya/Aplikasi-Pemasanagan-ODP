...
@section('content')
    ...
    <title>Pemasangan Jaringan</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Data Pemasangan Jaringan</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('jaringan.store') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="catatan"
                                                    ...
                                                    id="catatan" placeholder="Masukkan catatan"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="fotohasil" class="form-control"
                                                    placeholder="Masukan Foto Hasil">
                                            </div>
