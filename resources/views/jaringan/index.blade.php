        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <div class="row g-3 align-items-center mb-4">
                    <div class="col-auto">
                        <form action="jaringan" method="GET">
                            <input type="text" id="search" name="search" class="form-control" placeholder="Search">
                        </form>
                    </div>
                    {{-- Button Export PDF --}}
                    <div class="col-auto">
                        <a href="{{ route('jaringan.create')}}" class="btn btn-warning">
                            Tambah Data
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-2">Foto Hasil</th>
                        ...
                        <tbody>
                            ...
                            $no=1;
                            @endphp
                            @foreach ($jaringan as $index => $item)
                            <tr>
                                <th class="px-6 py-2">{{ $index + $jaringan->firstItem() }}</th>
                                ...
                                <td class="px-6 py-2">
                                    <img src="{{ asset('fotohasil/'.$item->fotohasil) }}" style="max-width: 150px; height: 120px;">
                                </td>
                                <td class="px-6 py-2">
                                    <a href="{{ route('jaringan.edit', $item->id) }}" class="btn btn-primary">Edit</a>
                                    <form action="{{ route('jaringan.destroy', $item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('delete')
