                        ...
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('jaringan.update', $item->id) }}"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select" name="id_masterclient" id="alat"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $item->catatan }}" type="text" name="catatan"
                                                    class="form-control" placeholder="Masukkan Catatan" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="statuspasang">Status Pasang</label>
                                                <select name="statuspasang" class="form-control" required>
                                                    <option value="Berhasil terpasang"
                                                        {{ $item->statuspasang == 'Berhasil terpasang' ? 'selected' : '' }}>
                                                        Berhasil terpasang</option>
                                                    <option value="Terkendala"
                                                        {{ $item->statuspasang == 'Terkendala' ? 'selected' : '' }}>
                                                        Terkendala</option>
                                                    <option value="Batal dipasang"
                                                        {{ $item->statuspasang == 'Batal dipasang' ? 'selected' : '' }}>
                                                        Batal dipasang</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($item->fotohasil)
                                                    <div class="mb-2">
                                                        <img src="{{ asset('fotohasil/' . $item->fotohasil) }}"
                                                            alt="Foto Hasil" width="150">
                                                    </div>
                                                @endif
