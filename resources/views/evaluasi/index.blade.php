        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <div class="row g-3 align-items-center mb-4">
                    <div class="col-auto">
                        <form action="evaluasi" method="GET">
                            <input type="text" id="search" name="search" class="form-control" placeholder="Search">
                        </form>
                    </div>
                    {{-- Button Export PDF --}}
                    <div class="col-auto">
                        <a href="{{ route('evaluasi.create')}}" class="btn btn-warning">
                            Tambah Data
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-2">
                                    <a href="{{ route('evaluasi.edit', $item->id) }}" class="btn btn-primary">Edit</a>
