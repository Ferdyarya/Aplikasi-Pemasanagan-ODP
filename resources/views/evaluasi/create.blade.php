    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Data Evaluasi</h1>
                    <div class="container">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('evaluasi.store') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="keterangankerja"
                                                    class="form-control @error('keterangankerja') is-invalid @enderror"
                                                    id="keterangankerja" placeholder="Masukkan keterangankerja"
                                                    value="{{ old('keterangankerja') }}" required>
                                                @error('keterangankerja')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>

                                            <div class="form-group">
                                                <label for="jumlahtugas">jumlahtugas</label>
                                                <input type="number" name="jumlahtugas"
                                                    class="form-control @error('jumlahtugas') is-invalid @enderror"
                                                    id="jumlahtugas" placeholder="Masukkan Jumlah Tugas"
                                                    value="{{ old('jumlahtugas') }}" required>
                                                @error('jumlahtugas')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
